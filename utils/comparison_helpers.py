...
def calculate_period_from_comparison_type(
    ...
    if comparison_type == "Latest month vs preceding month":
        return calculate_period_dates(max_date, 1, 'period')

    elif comparison_type == "Latest quarter vs preceding quarter":
        return calculate_period_dates(max_date, 3, 'period')

    elif comparison_type == "Latest 6 months vs preceding 6 months":
        return calculate_period_dates(max_date, 6, 'period')

    elif comparison_type == "Latest 12 months vs preceding 12 months":
        return calculate_period_dates(max_date, 12, 'period')

    elif comparison_type == "Year to date vs preceding year to date":
